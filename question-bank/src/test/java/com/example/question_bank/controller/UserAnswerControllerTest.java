...
public class UserAnswerControllerTest {
    ...
    @Test
    void getWrongQuestions_ShouldReturnPageOfWrongQuestions() throws Exception {
        // Arrange
        Page<UserAnswer> page = new PageImpl<>(Collections.emptyList());
        when(userAnswerService.getWrongQuestions(any(Long.class), any(PageRequest.class)))
            .thenReturn(page);
